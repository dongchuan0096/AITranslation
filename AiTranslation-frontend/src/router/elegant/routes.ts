...
export const generatedRoutes: GeneratedRoute[] = [
...

  {
    ...
    component: 'layout.base$view.professionaltranslate',
    meta: {
      title: 'professionaltranslate',
      i18nKey: 'route.professionaltranslate',
      order: 6,
  ...
  },
  {
    name: 'translatecomic',
    path: '/translatecomic',
    component: 'layout.base$view.translatecomic',
    meta: {
      title: 'translatecomic',
  ...
  },
  {
    name: 'translatetext',
    path: '/translatetext',
    component: 'layout.base$view.translatetext',
    meta: {
      title: 'translatetext',
      i18nKey: 'route.translatetext',
      order: 2,
      icon: 'mdi:translate'
    }
  },
  {
    name: 'translatevoice',
    path: '/translatevoice',
    component: 'layout.base$view.translatevoice',
    meta: {
      title: 'translatevoice',
      i18nKey: 'route.translatevoice',
      order: 4,
